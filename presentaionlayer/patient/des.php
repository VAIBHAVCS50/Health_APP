...
<table class="table2" id="myTable">
		...
		$sql3="SELECT * FROM doctor JOIN description ON doctor.DoctorID = description.doctorIDdesc and description.descID=$userID";
		$result3=$mysqli->query($sql3);
		if(mysqli_num_rows($result3)>=1){
			while ($row3=$result3->fetch_assoc()) {

				echo "<tr><td>".$row3['Doctorname']."</td><td>".$row3['ContactNumber']."</td><td>".$row3["Note"]."</td><td>".$row3["tim"]."</td></tr>";
			}
